---
title: "Generate synthetic data with an LLM and ellmer"
execute:
  eval: false
format: html
---
...
As mentioned earlier, common LLMs can simulate data for you, often through a chat interface. However, this typically requires downloading the data and manually loading it into R or Python, which adds an extra step to the workflow. 
...
# Generate synthetic data from a Shiny app
