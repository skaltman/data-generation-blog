...
Generating realistic but synthetic datasets is useful in various settings, from education to software testing. It enables controlled data that precisely fits one's needs. 
...
* **Prototyping a report**. Design a report, dashboard, or app before the data is available by creating data in the same format as the anticipated real data. 
